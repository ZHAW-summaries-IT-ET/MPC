...
\begin{KR}{Recipe: Choose \& Size Data Chunks}\\
    \textbf{Feasible?} heavy work = data-structure manipulation + similar op applied independently?
    \textbf{Pattern} array + local neighbourhood $\to$ Geometric Decomposition.
    \textbf{Shape} minimise surface/volume $\to$ square tiles.
    \textbf{Boundaries} 1-cell ghost halo; exchange a-priori or overlapped.
    \textbf{Map} \#chunks $>$ \#UEs for balancing.
\end{KR}
