...
\begin{KR}{Recipe: Trace a Memory Access}\\
    \paragraph{Pipeline} stage requests an address.
    ...
    \paragraph{Page fault} empty $\to$ MM loads frame from disk, updates page dir.
    \paragraph{Fill} TLB caches mapping; cache reads a line; write sets \important{dirty bit}.
\end{KR}
