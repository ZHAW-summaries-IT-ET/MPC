...
\begin{example2}{Ex.\ Pick the general solution}
...
\begin{example2}{Ex.\ Justify the path for Sobel}
...
\begin{example2}{Ex.\ Estimate the overhead}
...
\subsection{Efficiency \& Mapping Chunks to UEs}
...
\begin{example2}{Ex.\ Map 6 chunks to 4 UEs}
...
\subsection{Communication of Indices}
...
\begin{example2}{Ex.\ Local vs global indices}
