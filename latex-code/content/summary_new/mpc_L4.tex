...
\begin{concept}{Lernziele (Learning Goals)}
    \begin{enumerate}
        \item Explain \textbf{Flynn's taxonomy} (SISD / SIMD / MISD / MIMD) [s4]
        \item Explain the \textbf{SPMD} pattern the software abstraction of SIMD [s6--9]
        \item Understand the \textbf{SIMD motivation}: DSP kernels all reduce to multiply-accumulate [s10]
        \item Understand that \textbf{NEON is a vector-oriented MAC unit} (registers/lanes, no divide) [s17]
        \item Understand \textbf{NEON intrinsics} data types, lanes, specific instructions [s18/19]
        \item Understand \textbf{MISD / lockstep} (tight, software pendant, loose, real-world) [s21--24]
    \end{enumerate}
\end{concept}
