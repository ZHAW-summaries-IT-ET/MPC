...
\begin{concept}{Lernziele (Learning Goals)}
    \begin{enumerate}
        \item Know the \textbf{GP-CPU architectures} (Von Neumann / Harvard / Modified Harvard) [s4--6]
        \item Know the \textbf{ways to parallelise} a CPU [s7]
        \item Know how \textbf{VLIW / DSP} (multiple FUs) work [s8--10]
        \item Know \textbf{CISC vs RISC} + pipeline hazards [s11]
        \item Know \textbf{superpipelining vs superscalar} [s12]
        \item Know the \textbf{in/out-of-order} execution modes [s13]
        \item Understand \textbf{co-processors} (interface, sync, future) [s14--18]
        \item Know the principle of \textbf{SMT} [s19]
        \item Know the \textbf{AMP scenarios} + the questions to answer [s20--21]
        \item Know \textbf{openAMP} (remoteproc, rpmsg/virtio) [s22--25]
    \end{enumerate}
\end{concept}

\subsection{LZ1 GP-CPU Architectures}
...
\begin{example2}{Ex.\ LZ1 (s5) A53 architecture}
...
\subsection{LZ2 Parallelising a CPU}
...
\begin{example2}{Ex.\ LZ2 Name the four}
...
\subsection{LZ3 Multiple FUs: VLIW / DSP}
...
\begin{example2}{Ex.\ LZ3 (s8) DSP with .M/.D/.L/.S}
...
\subsection{LZ4 CISC/RISC \& Hazards}
...
\begin{example2}{Ex.\ LZ4 Why RISC pipelines better}
...
\subsection{LZ5 Superpipeline vs Superscalar}
...
\begin{example2}{Ex.\ LZ5 Distinguish}
...
\subsection{LZ6 In/Out-of-Order Execution}
...
\begin{example2}{Ex.\ LZ6 Which is most aggressive?}
...
\begin{example2}{Ex.\ LZ7 8087 / 8086}
...
\subsection{LZ8 SMT (Hyperthreading)}
...
\begin{example2}{Ex.\ LZ8 (s19) Why superscalar?}
...
\begin{example2}{Ex.\ LZ9 (s20) Different ISA under one OS?}
...
\begin{example2}{Ex.\ LZ10 Bring up an R5 on the Zynq}
