...
\begin{example2}{Ex.\ When is a GPU better?}
...
\subsubsection{Thread $\leftrightarrow$ Loop / Kernel}
...
\begin{example2}{Ex.\ (s27/28) Loop to kernel}
...
\subsection{Block \& Grid Organisation}
...
\begin{example2}{Ex.\ (s6) Threads for [10][5]}
...
\subsection{Execution Model (Grid $\to$ SM $\to$ Warps)}
...
\begin{example2}{Ex.\ What is an SM?}
...
\subsection{Limitations \& Best Practices}
...
\begin{example2}{Ex.\ (s10/11) Multiple of 32?}
...
\subsection{Rendering Pipeline \& GPU Evolution}
...
\subsection{OpenCL Models \& Platform}
...
\begin{example2}{Ex.\ Models \& hierarchy}
...
\subsection{Work-item / Work-group / NDRange}
...
\begin{example2}{Ex.\ (s26) 4096 work-items}
...
\begin{example2}{Ex.\ (s28) Who controls ordering?}
...
\begin{example2}{Ex.\ Where + how consistent?}
...
\subsection{OpenCL Synchronisation}
...
\begin{example2}{Ex.\ (s33) Coordinate work-items}
